export default function Loading() {
  return (
    <div className="min-h-screen bg-white animate-pulse">
      {/* Hero skeleton */}
      <section className="border-b border-gray-100 bg-gradient-to-r from-purple-50 via-indigo-50 to-violet-50 py-10">
        ...
        <div className="container-main py-6">
          <div className="flex gap-3 overflow-hidden">
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="h-20 w-32 rounded-xl bg-gray-100 flex-shrink-0" />
            ))}
          </div>
        </div>
      </section>
