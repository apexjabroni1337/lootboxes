  ...
  return (
    <div className="pb-12">
      ...
      <section className="border-b border-gray-100 dark:border-gray-800 bg-gradient-to-b from-gray-50 dark:from-gray-900 to-white dark:to-gray-950 py-8 sm:py-10">
        <div className="container-main">
          <div className="flex flex-col gap-6">
            <div>
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-50 dark:from-orange-950/30 to-amber-50 dark:to-amber-950/20 border border-orange-200 dark:border-orange-700/30 rounded-full px-4 py-1.5 mb-4 shadow-sm">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 px-4 py-2.5 shadow-sm">
                <Zap className="h-4 w-4 text-brand-600" />
                <div>
                  <p className="text-lg font-bold text-gray-900 dark:text-white">{deals.length}</p>
              ...
              <div className="flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 px-4 py-2.5 shadow-sm">
                ...
                <div>
                  <p className="text-lg font-bold text-gray-900 dark:text-white">{uniqueStores.size}+</p>
                  <p className="text-[11px] text-gray-500 dark:text-gray-400">Stores</p>
                </div>
              </div>
              {historicLowCount > 0 && (
                <div className="flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 px-4 py-2.5 shadow-sm">
                  ...
                  <div>
                    <p className="text-lg font-bold text-gray-900 dark:text-white">{historicLowCount}</p>
                    <p className="text-[11px] text-gray-500 dark:text-gray-400">Historic lows</p>
                  </div>
                </div>
              )}
              {bigDiscountCount > 0 && (
                <div className="flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 px-4 py-2.5 shadow-sm">
                  ...
                  <div>
                    <p className="text-lg font-bold text-gray-900 dark:text-white">{bigDiscountCount}</p>
                    <p className="text-[11px] text-gray-500 dark:text-gray-400">50%+ off</p>
                  </div>
                </div>
              )}
              {under10Count > 0 && (
                <div className="flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 px-4 py-2.5 shadow-sm">
                  ...
                  <div>
                    <p className="text-lg font-bold text-gray-900 dark:text-white">{under10Count}</p>
                    <p className="text-[11px] text-gray-500 dark:text-gray-400">Under $10</p>
                  </div>
                </div>
              )}
            </div>
      ...
      <div className="container-main mt-8">
        ...
        {/* Bottom CTA */}
        <div className="mt-10 rounded-xl border border-brand-200 dark:border-brand-700/30 bg-gradient-to-r from-brand-50 dark:from-brand-950/30 to-white dark:to-gray-950 p-6 sm:p-8">
