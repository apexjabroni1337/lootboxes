    ...
    <section className="border-b border-gray-100 bg-gray-50 py-4">
      <div className="container-main">
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Link
            href="/deals"
            className="group flex items-center gap-4 rounded-xl border border-gray-200 bg-white px-5 py-4 shadow-sm transition-all hover:border-brand-200 hover:shadow-md"
          >
            <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-lg bg-brand-50 text-brand-600 transition-colors group-hover:bg-brand-100">
          ...
          <Link
            ...
            className="group flex items-center gap-4 rounded-xl border border-gray-200 bg-white px-5 py-4 shadow-sm transition-all hover:border-success-600/30 hover:shadow-md"
          >
