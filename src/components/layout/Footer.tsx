    ...
    <footer className="border-t border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-gray-950">
      ...
      <div className="border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
        <div className="container-main py-6">
          <p className="text-center text-[11px] font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500">
          ...
          <div className="mt-3 flex flex-wrap items-center justify-center gap-3">
            {TRACKED_STORES.map((key) => {
              ...
              return (
                <span
                  key={key}
                  className="flex items-center gap-1.5 rounded-full border border-gray-100 bg-gray-50 px-3 py-1.5 dark:border-gray-700 dark:bg-gray-800"
                >
                  <span
      ...
      <div className="container-main py-12">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-6">
          ...
          <div className="col-span-2">
            ...
            <div className="mt-5 flex gap-2">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-400 dark:text-gray-500 transition-colors hover:border-brand-300 hover:text-brand-600 dark:border-gray-700 dark:bg-gray-900 dark:hover:border-brand-500"
                aria-label="Twitter"
              >
          ...
          {Object.entries(FOOTER_SECTIONS).map(([heading, links]) => (
            <div key={heading}>
              <h4 className="text-sm font-semibold text-gray-900 dark:text-white">{heading}</h4>
        ...
        {/* Bottom bar */}
        <div className="mt-12 flex flex-col items-center gap-4 border-t border-gray-200 pt-6 sm:flex-row sm:justify-between dark:border-gray-800">
          <p className="text-xs text-gray-400 dark:text-gray-500">
            &copy; {new Date().getFullYear()} LootBoxes.com. All rights reserved.
          </p>
          <p className="max-w-lg text-center text-[11px] text-gray-400 dark:text-gray-500 sm:text-right">
